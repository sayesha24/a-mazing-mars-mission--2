...
function preload(){
 ...
 asteroids_img= loadImage("asteroid.png");
 aliens_img= loadImage("alien.png");
 laserbeem_img= loadImage("laserbeem.png");
...
function SpawnAliens(){
  ...
  if(frameCount% 300=== 0 && score >= 3 && score <=5){
